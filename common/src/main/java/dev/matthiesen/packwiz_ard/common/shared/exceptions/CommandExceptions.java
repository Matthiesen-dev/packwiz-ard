...
public final class CommandExceptions {
     ...
     public static final SimpleCommandExceptionType UPDATE_IN_PROGRESS_ERROR = new SimpleCommandExceptionType(Component.literal("Packwiz update is already in progress"));
     public static final SimpleCommandExceptionType NO_PACK_TOML = new SimpleCommandExceptionType(Component.literal("There is no pack.toml link to update from. Add this using /packwizard link [url]."));
